...
type Config struct {
	DASBaseDir         string              `yaml:"dasBaseDir"`         // Base directory for DAS files
	ETLBaseDir         string              `yaml:"etlBaseDir"`         // Base directory for ETL files
...
func DefaultConfig() Config {
	return Config{
		DASBaseDir:         "c:/mnt/data/das",
		ETLBaseDir:         "c:/mnt/data/etl",
